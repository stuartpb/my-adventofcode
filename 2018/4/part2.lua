...
for guard, hoursleep in pairs(sleepers) do
  local sleepiestminute = maxkey(hoursleep)
  sleepers[guard] = sleepiestminute
  sleeptotals[guard] = hoursleep[sleepiestminute]
end
local sleepiestguard = maxkey(sleeptotals)
print(tonumber(sleepiestguard) * sleepers[sleepiestguard])
